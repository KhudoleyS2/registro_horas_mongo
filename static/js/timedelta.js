var elemento_date_inicio_registro = document.getElementById('date_inicio_registro');

if (typeof(elemento_date_inicio_registro) != 'undefined' && elemento_date_inicio_registro != null ){

    // Datetime string formato python.
    var datetime_python = elemento_date_inicio_registro.innerHTML;
